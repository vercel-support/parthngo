            ...
            <div className="row justify-content-center">
                ...
                <div className="col-lg-4 col-md-7">
                    <div className="single_services_2 text-center mt-30 services_2_color_2">
                        ...
                        <div className="services_content">
                            <h4 className="services_title"><a href="#">Donate Now</a></h4>
                            <p style={{textAlign:'justify',fontSize:'14px'}}>silai, kadhai, bunai, beauty parlor , mehandi prashikshad , fashion designing , redimat garments prashikshad.</p>
                        </div>
                    </div> 
                </div>
                <div className="col-lg-4 col-md-7">
                ...
                <div className="col-lg-4 col-md-7">
                    <div className="single_services_2 text-center mt-30 services_2_color_2">
                        ...
                        <div className="services_content">
                            <h4 className="services_title"><a href="#">Donate Now</a></h4>
                            <p>Samaj mai shoshit,besahara aur kamjoor varg ki mahilao aur baccho mai samajik , shaksadhik , aarthik uttan ke liye samarpit sanstha.</p>
                        </div>
                    </div> 
                </div>
